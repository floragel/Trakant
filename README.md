...
app/
 ...
 │        │      ├── TrakAntComponents.kt
 │        │      ├── TrakAntData.kt
 │        │      └── ui/theme/          (thème Jetpack Compose)
 │        │
 │        ├── java/com/example/trakant/assets/
 │        │      ├── game_data.json     (config des quêtes & missions)
 │        │      ├── house_lvl_1.png
 │        │      ├── house_lvl_2.png
 │        │      ├── house_lvl_3.png
 │        │      ├── house_lvl_4.png
 │        │      └── pixel_ant.png      (pixel art de la fourmi)
 │        │
 │        └── res/
 │              ├── drawable/           (ressources graphiques diverses)
 │              ├── mipmap-anydpi-v26/
 │              ├── mipmap-hdpi/
 │              ├── mipmap-mdpi/
 │              ├── mipmap-xhdpi/
 │              ├── mipmap-xxhdpi/
 │              ├── mipmap-xxxhdpi/     (icônes de l’app)
 │              ├── values/             (couleurs, thèmes, strings, etc.)
 │              └── xml/
 │
 └── build.gradle.kts
\`\`\`
